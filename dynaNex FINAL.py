...
class DynaNextForm(WinForms.Form):
    ...
    def InitializeForm(self):
        ...
        self.Size = Drawing.Size(1400, 980)  # Increased height for better progress bar spacing
        self.StartPosition = WinForms.FormStartPosition.CenterScreen
        self.FormBorderStyle = WinForms.FormBorderStyle.Sizable
        self.MinimumSize = Drawing.Size(1200, 900)  # Increased minimum height too
        ...
        main_panel.RowStyles.Add(WinForms.RowStyle(WinForms.SizeType.Percent, 45))   # Categories + Parameters (reduced further for progress bar spacing)
        main_panel.RowStyles.Add(WinForms.RowStyle(WinForms.SizeType.Absolute, 55))  # Selection buttons
        main_panel.RowStyles.Add(WinForms.RowStyle(WinForms.SizeType.Absolute, 140)) # Action buttons (increased to 140 for better progress bar spacing)
...
# Title section (center)
        ...
        self.settings_status_label.Text = "User Settings: Default"
        ...
        aboutme_panel.RowStyles.Add(WinForms.RowStyle(WinForms.SizeType.Absolute, 25))  # Text and spacing - increased for better toggle visibility
        ...
        button_row_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Percent, 100))  # Flexible space to push toggles to right
        button_row_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 80))  # "Switch Mode" text
        button_row_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 40))  # Dark theme dot - wider
        button_row_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 10))  # Small space between toggles
        button_row_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 40))  # Light theme dot - wider
        ...
        switch_mode_label.ForeColor = Drawing.Color.FromArgb(156, 163, 175)  # Medium gray
        switch_mode_label.TextAlign = Drawing.ContentAlignment.MiddleCenter
        switch_mode_label.Dock = WinForms.DockStyle.Fill
        switch_mode_label.BackColor = Drawing.Color.FromArgb(51, 65, 85)  # Match panel background

        # Dark theme button (dot style) - consistent size
        self.dark_theme_btn = WinForms.Button()
        self.dark_theme_btn.Text = "●"
        self.dark_theme_btn.Size = Drawing.Size(28, 28)
        ...
        self.dark_theme_btn.Font = Drawing.Font("Arial", 12, Drawing.FontStyle.Bold)
        ...
        # Light theme button (dot style) - consistent size
        self.light_theme_btn = WinForms.Button()
        self.light_theme_btn.Text = "●"
        self.light_theme_btn.Size = Drawing.Size(28, 28)
        ...
        self.light_theme_btn.Font = Drawing.Font("Arial", 12, Drawing.FontStyle.Bold)
        ...
        # Theme label panel for status text under toggles
        ...
        theme_label_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Percent, 100))  # Flexible space
        theme_label_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 80))  # Empty space under "Switch Mode"
        theme_label_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 40))  # Dark button status - wider
        theme_label_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 10))  # Small spacer
        theme_label_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 40))  # Light button status - wider

        # Theme status labels under buttons
        dark_label = WinForms.Label()
        dark_label.Text = "Dark"
        dark_label.Font = Drawing.Font("Segoe UI", 8.5, Drawing.FontStyle.Regular)
        dark_label.ForeColor = Drawing.Color.FromArgb(156, 163, 175)  # Light gray
        dark_label.BackColor = Drawing.Color.FromArgb(51, 65, 85)  # Match panel background
        ...
        light_label.ForeColor = Drawing.Color.FromArgb(156, 163, 175)  # Light gray
        light_label.BackColor = Drawing.Color.FromArgb(51, 65, 85)  # Match panel background
        ...
        # Column 1 is flexible spacer
        button_row_panel.Controls.Add(switch_mode_label, 2, 0)
        button_row_panel.Controls.Add(self.dark_theme_btn, 3, 0)
        # Column 4 is small spacer between toggles
        button_row_panel.Controls.Add(self.light_theme_btn, 5, 0)
        ...
        self.active_view_btn.Font = Drawing.Font("Arial", 11, Drawing.FontStyle.Bold)
        ...
        self.whole_model_btn.Font = Drawing.Font("Arial", 11, Drawing.FontStyle.Bold)
        ...
        # Search panel - Clean layout with proper alignment
        ...
        search_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 100))  # Filter label
        search_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Percent, 45))    # Categories textbox
        search_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 70))   # Clear categories btn - wider
        search_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Percent, 45))    # Parameters textbox  
        search_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 70))   # Clear parameters btn - wider
        ...
        clear_cat_btn.Size = Drawing.Size(65, 23)  # Wider to prevent text wrapping
        clear_cat_btn.Anchor = WinForms.AnchorStyles.Top  # Align to top of cell
        ...
        clear_param_btn.Size = Drawing.Size(65, 23)  # Wider to prevent text wrapping
        clear_param_btn.Anchor = WinForms.AnchorStyles.Top  # Align to top of cell
        ...
        # Direct layout - simpler and cleaner
        ...
        search_panel.Controls.Add(self.search_parameters_textbox, 3, 0)
        ...
        self.categories_checklist.Font = Drawing.Font("Segoe UI", 10, Drawing.FontStyle.Bold)  # Reduced font size
        self.categories_checklist.ItemHeight = 18  # Reduced size to save space
        ...
        self.parameters_checklist.Font = Drawing.Font("Segoe UI", 10, Drawing.FontStyle.Bold)  # Reduced font size
        self.parameters_checklist.ItemHeight = 18  # Reduced size to save space
        ...
        self.category_count_label.Font = Drawing.Font("Arial", 11, Drawing.FontStyle.Bold)  # Increased font size
        ...
        self.parameter_count_label.Font = Drawing.Font("Arial", 11, Drawing.FontStyle.Bold)  # Increased font size
        ...
        action_panel = self.action_panel  # Keep reference for compatibility
        ...
        action_panel.ColumnCount = 6  # Increased for refresh/close buttons on right
        ...
        action_panel.RowStyles.Add(WinForms.RowStyle(WinForms.SizeType.Absolute, 50))  # Progress bar - increased height for breathing room
        
        # Column styles for proper spacing
        action_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 210))  # Export button
        action_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 210))  # Import button
        action_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Percent, 100))   # Flexible space
        action_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 50))   # Spacer
        action_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 130))  # Refresh button
        action_panel.ColumnStyles.Add(WinForms.ColumnStyle(WinForms.SizeType.Absolute, 130))  # Close button
        
        action_panel.Padding = WinForms.Padding(10, 5, 10, 15)  # Increased bottom padding for progress bar
        ...
        refresh_btn.Size = Drawing.Size(120, 30)  # Smaller size for side-by-side layout
        ...
        close_btn.Size = Drawing.Size(120, 30)  # Smaller size for side-by-side layout
        ...
        # Progress bar
        # Custom visual progress bar with green fill
        self.progress_bar = WinForms.ProgressBar()
        self.progress_bar.Dock = WinForms.DockStyle.Fill
        self.progress_bar.Visible = False
        self.progress_bar.Style = WinForms.ProgressBarStyle.Continuous
        self.progress_bar.Minimum = 0
        self.progress_bar.Maximum = 100
        self.progress_bar.Value = 0
        
        # Set progress bar colors - green fill
        self.progress_bar.ForeColor = Drawing.Color.FromArgb(34, 197, 94)  # Green fill color
        
        # Create a custom paint handler for better visual progress
        self.progress_panel = WinForms.Panel()
        self.progress_panel.Anchor = WinForms.AnchorStyles.Left | WinForms.AnchorStyles.Right | WinForms.AnchorStyles.Top
        self.progress_panel.Location = Drawing.Point(0, 10)  # Move it down 10px from top of cell
        self.progress_panel.Height = 38  # Good size progress bar for user satisfaction!
        self.progress_panel.BackColor = Drawing.Color.FromArgb(51, 65, 85)  # Dark background
        self.progress_panel.BorderStyle = WinForms.BorderStyle.FixedSingle
        self.progress_panel.Visible = False
        
        # Progress fill panel (green strip)
        self.progress_fill = WinForms.Panel()
        self.progress_fill.Height = 36  # Match the progress panel with 2px border
        self.progress_fill.Width = 0  # Start at 0 width
        self.progress_fill.BackColor = Drawing.Color.FromArgb(34, 197, 94)  # Green fill
        self.progress_fill.Location = Drawing.Point(1, 1)
        self.progress_fill.Anchor = WinForms.AnchorStyles.Left | WinForms.AnchorStyles.Top | WinForms.AnchorStyles.Bottom
        
        # Progress percentage counter - standalone to the left of progress bar
        self.progress_text = WinForms.Label()
        self.progress_text.Dock = WinForms.DockStyle.Fill
        self.progress_text.TextAlign = Drawing.ContentAlignment.MiddleCenter
        self.progress_text.BackColor = Drawing.Color.FromArgb(30, 41, 59)  # Match action panel background
        self.progress_text.ForeColor = Drawing.Color.White
        self.progress_text.Font = Drawing.Font("Segoe UI", 12, Drawing.FontStyle.Bold)
        self.progress_text.Text = "0%"
        
        # Add only the green fill to progress panel (text is now external)
        self.progress_panel.Controls.Add(self.progress_fill)
        ...
        action_panel.Controls.Add(export_btn, 0, 0)     # Export in top left
        action_panel.Controls.Add(import_btn, 1, 0)     # Import next to export
        action_panel.Controls.Add(settings_btn, 0, 1)   # Settings in second row left
        action_panel.Controls.Add(help_btn, 1, 1)       # Help next to settings
        action_panel.Controls.Add(self.status_label, 2, 1)  # Status in second row
        action_panel.Controls.Add(self.progress_text, 0, 2)  # Percentage counter in bottom row left
        action_panel.Controls.Add(self.progress_panel, 1, 2)  # Progress bar in bottom row middle
        action_panel.SetColumnSpan(self.progress_panel, 2)  # Span across columns 1-2
        action_panel.Controls.Add(refresh_btn, 4, 1)    # Move refresh to middle row right
        action_panel.Controls.Add(close_btn, 5, 1)      # Move close to middle row extreme right
        ...
        try:
            ...
            for i, element in enumerate(elements):
                ...
                if i % 100 == 0:
                    ...
                    self.UpdateProgress(progress, "Analyzing categories... " + str(progress) + "%")
            ...
            for i, element in enumerate(sample_elements):
                ...
                if i % 10 == 0:
                    ...
                    self.UpdateProgress(progress, "Analyzing parameters... " + str(progress) + "%")
                    WinForms.Application.DoEvents()
    ...
    def CreateCategoryBasedExcel(self, category_elements, parameters, file_path):
        ...
        try:
            ...
            for category_name, elements in category_elements.items():
                current_category += 1
                # Keep progress bar visible and reset for new category
                if self.progress_panel:
                    self.progress_panel.Visible = True
                    self.progress_fill.Width = 0  # Reset to 0 for new category
                    self.progress_text.Text = "0%"
                self.status_label.Text = "Processing " + category_name + " (" + str(current_category) + "/" + str(total_categories) + ")..."
                ...
                for i in range(0, len(elements), batch_size):
                    ...
                    self.UpdateProgress(progress, category_name + ": " + str(progress) + "% (" + str(processed) + "/" + str(len(elements)) + ")")
                    WinForms.Application.DoEvents()
            ...
            for row in range(2, last_row + 1):
                try:
                    ...
                    if row % 10 == 2:  # Every 10 elements starting from row 2
                        ...
                        self.UpdateProgress(progress_pct, "Updating elements... " + str(progress_pct) + "%")
                        WinForms.Application.DoEvents()
    ...
    def ApplyDarkTheme(self):
        ...
        try:
            ...
            colors = {
                'main_bg': Drawing.Color.FromArgb(30, 41, 59),      # Dark blue - uniform main background
                'panel_bg': Drawing.Color.FromArgb(30, 41, 59),     # Same as main for uniformity
                'input_bg': Drawing.Color.FromArgb(71, 85, 105),    # Light blue for inputs
                'text_light': Drawing.Color.FromArgb(220, 220, 220), # Light text
                'text_medium': Drawing.Color.FromArgb(156, 163, 175) # Medium text
            }
            
            # Apply main form background first for uniformity
            self.BackColor = colors['main_bg']
            
            # Update all controls recursively with uniform colors
            self.UpdateControlColors(self, colors, True)
            
            # Force complete refresh for uniform appearance
            self.SuspendLayout()
            ...
            # Show error if theme application fails
            pass
    ...
    def ApplyLightTheme(self):
        ...
        try:
            ...
            colors = {
                'main_bg': Drawing.Color.FromArgb(248, 250, 252),   # Very light blue-gray - uniform main background
                'panel_bg': Drawing.Color.FromArgb(248, 250, 252),  # Same as main for uniformity
    ...
    def UpdateControlColors(self, control, colors, is_dark):
        ...
        try:
            # Skip theme toggle buttons and progress components - they have special handling
            if (control == self.dark_theme_btn or control == self.light_theme_btn):
                return
            ...
            if hasattr(control, 'BackColor'):
                if isinstance(control, WinForms.Form):
                    # Main form - ensure uniform background
                    control.BackColor = colors['main_bg']
                    
                elif isinstance(control, WinForms.TableLayoutPanel):
                    # All table layout panels use consistent background
                    # Check if it's a top-level panel or nested
                    try:
                        # For uniform appearance, use main_bg for all TableLayoutPanels
                        control.BackColor = colors['main_bg']
                    except:
                        control.BackColor = colors['panel_bg']
                        
                elif isinstance(control, WinForms.Panel):
                    # Generic panels - ensure uniform background
                    control.BackColor = colors['panel_bg']
                    ...
                    # Labels - ensure consistent background unless transparent
                    try:
                        current_bg = str(control.BackColor)
                        if 'Transparent' not in current_bg:
                            # Check parent to determine appropriate background
                    ...
                    # Skip regular buttons unless they're special UI buttons
                    if not (hasattr(control, 'Text') and control.Text in ["Save As", "Load As", "About Me"]):
                        # Only update non-action buttons to maintain their styling
                        pass
                
                elif control == self.progress_panel:
                    # Progress bar background panel
                    if is_dark:
                        control.BackColor = Drawing.Color.FromArgb(51, 65, 85)  # Dark background
                    else:
                        control.BackColor = Drawing.Color.FromArgb(229, 231, 235)  # Light gray background
                    # Ensure border is visible in both themes
                    control.BorderStyle = WinForms.BorderStyle.FixedSingle
                    # Force refresh the progress panel
                    control.Invalidate()
                
                elif control == self.progress_fill:
                    # Progress bar fill - use different green shades for better visibility
                    if is_dark:
                        control.BackColor = Drawing.Color.FromArgb(34, 197, 94)   # Standard green for dark mode
                    else:
                        control.BackColor = Drawing.Color.FromArgb(22, 163, 74)   # Darker green for light mode (better contrast)
                    # Ensure it's on top
                    control.BringToFront()
                    # Force refresh the fill panel
                    control.Invalidate()
                
                elif control == self.progress_text:
                    ...
                    if is_dark:
                        ...
                        control.BackColor = colors['main_bg']
                        control.ForeColor = Drawing.Color.FromArgb(51, 65, 85)  # Dark text on light background
                
                elif control == self.action_panel:
                    # Action panel containing the progress bar
                    control.BackColor = colors['main_bg']  # Use main background color
                    # Force refresh to ensure progress bar visibility
                    control.Invalidate()
                    
                else:
                    # Any other control with BackColor - ensure uniform background
                    try:
                        control.BackColor = colors['panel_bg']
                        if hasattr(control, 'ForeColor'):
                            control.ForeColor = colors['text_light']
    ...
    def RefreshProgressBarColors(self):
        ...
        try:
            ...
            # Update action panel background
            ...
            # Update progress panel background
            if hasattr(self, 'progress_panel'):
                if is_dark:
                    self.progress_panel.BackColor = Drawing.Color.FromArgb(51, 65, 85)
                else:
                    self.progress_panel.BackColor = Drawing.Color.FromArgb(229, 231, 235)
                    
            # Update progress fill color
            if hasattr(self, 'progress_fill'):
                if is_dark:
                    self.progress_fill.BackColor = Drawing.Color.FromArgb(34, 197, 94)
                else:
                    self.progress_fill.BackColor = Drawing.Color.FromArgb(22, 163, 74)
                self.progress_fill.BringToFront()
                    
            # Update progress text
            if hasattr(self, 'progress_text'):
                if is_dark:
                    self.progress_text.BackColor = Drawing.Color.FromArgb(30, 41, 59)
                    self.progress_text.ForeColor = Drawing.Color.White
                else:
                    self.progress_text.BackColor = Drawing.Color.FromArgb(248, 250, 252)
                    self.progress_text.ForeColor = Drawing.Color.FromArgb(51, 65, 85)
                    
            # Force redraws
            if hasattr(self, 'progress_panel'):
                self.progress_panel.Invalidate()
            if hasattr(self, 'progress_fill'):
                self.progress_fill.Invalidate()
            if hasattr(self, 'action_panel'):
...
🏢 DynaNex - "Power your Connections"
   Advanced Revit-Excel Parameter Management Tool"""
        ...
        help_form.Size = Drawing.Size(850, 750)  # Larger window for better readability
        help_form.StartPosition = WinForms.FormStartPosition.CenterParent
        help_form.MaximizeBox = True  # Allow maximizing for even better readability
        help_form.MinimizeBox = False
        help_form.BackColor = Drawing.Color.FromArgb(30, 41, 59)  # Dark theme
        
        help_textbox = WinForms.RichTextBox()  # Changed to RichTextBox for better formatting
        ...
        help_textbox.Font = Drawing.Font("Segoe UI", 11)  # Larger font for better readability
        help_textbox.BackColor = Drawing.Color.FromArgb(51, 65, 85)  # Dark background
        help_textbox.ForeColor = Drawing.Color.FromArgb(220, 220, 220)  # Light text
        help_textbox.WordWrap = True
        help_textbox.DetectUrls = False
        help_textbox.Text = help_text
        
        # Apply bold formatting to headings and steps
        help_textbox.Select(0, 0)  # Start at beginning
        
        # List of text patterns to make bold
        bold_patterns = [
        ...
        # Apply bold formatting to each pattern
    ...
    def ShowProgress(self, show=True, message="Processing...", progress_percent=0):
        """Show/hide visual progress bar with percentage fill"""
        try:
            if self.progress_panel:
                self.progress_panel.Visible = show
                if show:
                    # Ensure correct theme colors when showing progress bar
                    self.RefreshProgressBarColors()
                    # Update progress fill width based on percentage
                    if progress_percent > 0:
                        panel_width = self.progress_panel.Width - 2  # Account for border
                        fill_width = int((progress_percent / 100.0) * panel_width)
                        self.progress_fill.Width = max(0, min(fill_width, panel_width))
                        self.progress_text.Text = str(progress_percent) + "%"
                    else:
    ...
    def UpdateProgress(self, progress_percent, message="Processing..."):
        """Update progress bar with specific percentage"""
        try:
            if self.progress_panel:
                # Ensure progress bar is visible and has correct colors
                self.progress_panel.Visible = True
                self.RefreshProgressBarColors()
...
class DynaNextSettingsForm(WinForms.Form):
    ...
    def InitializeForm(self):
        ...
        self.Size = Drawing.Size(550, 600)  # Increased height to ensure buttons are visible
        ...
        main_panel.RowStyles.Add(WinForms.RowStyle(WinForms.SizeType.Absolute, 80))   # Buttons - row 5 (increased height)
        ...
        button_panel.Padding = WinForms.Padding(15, 20, 15, 15)  # More padding: left, top, right, bottom
